...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["components-register-register-module"], {
    ...
    function NgOtpInputComponent_div_0_input_1_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("keydown", function NgOtpInputComponent_div_0_input_1_Template_input_keydown_0_listener($event) {
          ...
          return ctx_r282.onKeyDown($event);
          ...
          return ctx_r284.onKeyUp($event, i_r281);
        });
    ...
    */
    ...
    function RegisterComponent_div_40_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function RegisterComponent_div_40_Template_div_click_0_listener() {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r843);

          var item_r841 = ctx.$implicit;

          var ctx_r842 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          return ctx_r842.selectedCC(item_r841);
        });
    ...
    function () {
      ...
      _createClass(RegisterComponent, [{
          ...
          if (this.userCode) {
            ...
            this.api.post('users/verifyOTP', param).subscribe(function (data) {
              ...
              if (data && data.status === 200) {
                ...
                _this5.api.post('users/edit_profile', params).subscribe(function (data) {
                  _this5.util.stop();

                  console.log(data);
                  localStorage.setItem('uid', _this5.uid);
                  ...
                  Toast.fire({
                    icon: 'success',
                    title: _this5.util.getString('Signed up successfully')
                  });
                ...
                if (data && data.status === 500 && data.data && data.data.message) {
                  ...
                  _this5.util.toast('error', _this5.util.getString('Error'), data.data.message);
        ...
        value: function goToHome() {
          ...
          this.util.start();
          this.api.post('users/registerUser', param).subscribe(function (data) {
            _this6.util.stop();

            console.log(data);

            if (data && data.status === 200) {
              if (_this6.util.twillo === '1') {
                _this6.uid = data.data.id;
                ...
                Toast.fire({
                  icon: 'success',
                  title: _this6.util.getString('Signed up successfully')
                });

                _this6.sendVerification(_this6.email, _this6.api.baseUrl + 'users/verify?uid=' + data.data.id);

                _this6.router.navigate(['/home']);
              }
            } else if (data && data.status === 500) {
              _this6.util.toast('error', _this6.util.getString('Error'), data.data.message);
            } else {
    ...
    RegisterComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      template: function RegisterComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function RegisterComponent_Template_button_click_8_listener() {
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r844);

            var _r839 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵreference"](2);
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("onInputChange", function RegisterComponent_Template_ng_otp_input_onInputChange_22_listener($event) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function RegisterComponent_Template_input_ngModelChange_39_listener($event) {
            return ctx.cc = $event;
          })("ngModelChange", function RegisterComponent_Template_input_ngModelChange_39_listener($event) {
            return ctx.onCountryInput($event);
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function RegisterComponent_Template_select_ngModelChange_42_listener($event) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function RegisterComponent_Template_button_click_49_listener() {
            return ctx.goToHome();
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function RegisterComponent_Template_label_click_52_listener() {
  ...
  function srcAppComponentsRegisterRegisterModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    */
    ...
    RegisterModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineNgModule"]({
      type: RegisterModule
    });
    RegisterModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjector"]({
      factory: function RegisterModule_Factory(t) {
        return new (t || RegisterModule)();
      },
      imports: [[_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _register_routing_module__WEBPACK_IMPORTED_MODULE_3__["RegisterRoutingModule"], src_app_shared_shared_module__WEBPACK_IMPORTED_MODULE_5__["SharedModule"], ng_otp_input__WEBPACK_IMPORTED_MODULE_6__["NgOtpInputModule"], angular_bootstrap_md__WEBPACK_IMPORTED_MODULE_7__["MDBBootstrapModule"].forRoot(), _angular_forms__WEBPACK_IMPORTED_MODULE_0__["FormsModule"]]]
    });
    ...
    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](RegisterModule, {
        ...
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _register_routing_module__WEBPACK_IMPORTED_MODULE_3__["RegisterRoutingModule"], src_app_shared_shared_module__WEBPACK_IMPORTED_MODULE_5__["SharedModule"], ng_otp_input__WEBPACK_IMPORTED_MODULE_6__["NgOtpInputModule"], angular_bootstrap_md__WEBPACK_IMPORTED_MODULE_7__["MDBRootModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_0__["FormsModule"]]
      });
    })();
    /*@__PURE__*/
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](RegisterModule, [{
